...
- 345 features: **127** supported, **15** partial, **0** unsupported, **203** untested
...
| narrowing.translates_logical_nullish_assign                    | 🟡 partial   | src\main.rs:3:9: error[E0384]: cannot assign to immutable argument `x`: cannot assign to immutable argument src\main.rs:3:9: warning: value assigned to `x` is never read error: could not compile `probe` (bin "probe") due to 1 previous error; 1 warning emitted |
| narrowing.translates_logical_or_assign                         | 🟡 partial   | src\main.rs:3:9: error[E0384]: cannot assign to immutable argument `x`: cannot assign to immutable argument src\main.rs:3:9: warning: value assigned to `x` is never read error: could not compile `probe` (bin "probe") due to 1 previous error; 1 warning emitted |
...
| operators.translates_field_assign_to_field          | 🟡 partial   | src\main.rs:1:9: error[E0425]: cannot find type `Vector` in this scope: not found in this scope error: could not compile `probe` (bin "probe") due to 1 previous error                                                                                                                                                                                                                                                                                                                       |
...
| operators.translates_bitwise_compound_assign        | 🟡 partial   | src\main.rs:2:5: error[E0384]: cannot assign to immutable argument `a`: cannot assign to immutable argument src\main.rs:3:5: error[E0384]: cannot assign to immutable argument `a`: cannot assign to immutable argument src\main.rs:4:5: error[E0384]: cannot assign to immutable argument `a`: cannot assign to immutable argument src\main.rs:4:5: warning: value assigned to `a` is never read error: could not compile `probe` (bin "probe") due to 3 previous errors; 1 warning emitted |
...
| strings.translates_string_predicate_methods          | 🟡 partial   | src\main.rs:4:19: error[E0308]: mismatched types: expected `bool`, found floating-point number error: could not compile `probe` (bin "probe") due to 1 previous error |
...
| types.translates_default_param_supplied_wraps_some               | 🟡 partial   | src\main.rs:3:16: error[E0308]: mismatched types: expected `&str`, found `String` error: could not compile `probe` (bin "probe") due to 1 previous error                                                                 |
...
| types.translates_object_keys_to_hashmap_keys                     | 🟡 partial   | src\main.rs:2:5: error[E0308]: mismatched types: expected `f64`, found `usize` error: could not compile `probe` (bin "probe") due to 1 previous error                                                                    |
| types.translates_object_values_to_hashmap_values                 | 🟡 partial   | src\main.rs:2:5: error[E0308]: mismatched types: expected `f64`, found `usize` error: could not compile `probe` (bin "probe") due to 1 previous error                                                                    |
