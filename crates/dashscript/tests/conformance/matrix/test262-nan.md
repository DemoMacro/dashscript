...
| test262.test.built-ins.nan.s15.1.1.1_a4    | 🟡 partial   | src\main.rs:3:17: error: `this` is only valid inside a class method error: could not compile `probe` (bin "probe") due to 1 previous error |
