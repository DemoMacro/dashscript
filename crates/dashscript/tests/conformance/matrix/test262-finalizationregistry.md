...
- 37 features: **37** supported, **0** partial, **0** unsupported, **0** untested
...
| test262.test.built-ins.finalizationregistry.proto-from-ctor-realm                                                                  | 🟢 supported | via rquickjs engine |
