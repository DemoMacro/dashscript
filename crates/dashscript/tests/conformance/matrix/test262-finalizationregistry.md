...
- 37 features: **36** supported, **1** partial, **0** unsupported, **0** untested
...
| test262.test.built-ins.finalizationregistry.proto-from-ctor-realm                                                                  | 🟡 partial   | engine error: Exception generated by QuickJS |
