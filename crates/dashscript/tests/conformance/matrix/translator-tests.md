...
- 201 features: **197** supported, **1** partial, **3** unsupported, **0** untested
...
| math.translates_math_constants                  | 🔴 unsupported | `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| math.translates_math_exp_log_trig_methods       | 🟢 supported   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| math.translates_math_expm1_to_exp_m1            | 🟢 supported   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| math.translates_math_extra_constants            | 🔴 unsupported | `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation) \| `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation) \| `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation) \| `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation) \| `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation) \| `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation) |
...
| math.translates_math_min_and_e_constant         | 🔴 unsupported | `Math` as a value is unsupported (use it only as a static-call/new receiver or type annotation)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
