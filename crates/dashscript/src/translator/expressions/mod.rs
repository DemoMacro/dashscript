...
pub(in crate::translator) use member::{
    ...
    is_abort_signal_receiver, is_event_target_local, is_hashmap_local, is_hashset_local,
    is_headers_local, is_text_decoder_local, is_url_local, is_url_search_params_local,
