...
pub(in crate::translator) use web::{
    ...
    headers_ctor_type, headers_method, is_crypto_subtle_member, perf_method, readable_stream_ctor,
    request_ctor, request_ctor_type, response_ctor, response_ctor_type, streams_ctor_type,
    streams_method, text_decoder_method, text_encoder_method, url_ctor_type,
