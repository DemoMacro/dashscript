...
pub(in crate::translator) use web::{
    compression_ctor_type, compression_method, compression_stream_ctor, console_method,
    crypto_method, encoding_ctor_type, event_init, event_target_ctor_type, event_target_method,
